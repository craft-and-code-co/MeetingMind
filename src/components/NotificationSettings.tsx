    ...
    <div className="px-6 py-4 space-y-4">
      ...
      {permission === 'granted' && (
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <div>
              <h4 className="text-sm font-medium text-gray-900">Meeting Notifications</h4>
              <p className="text-sm text-gray-500">Get notified when meetings start and end</p>
            </div>
            <input
              type="checkbox"
          ...
          <div className="flex items-center justify-between">
            <div>
              <h4 className="text-sm font-medium text-gray-900">Transcription Notifications</h4>
              <p className="text-sm text-gray-500">Get notified when transcription is ready</p>
            </div>
            <input
              type="checkbox"
          ...
          <div className="flex items-center justify-between">
            <div>
              <h4 className="text-sm font-medium text-gray-900">Action Item Notifications</h4>
              <p className="text-sm text-gray-500">Get notified about due action items</p>
            </div>
            <input
              type="checkbox"
          ...
          <div className="flex items-center justify-between">
            <div>
              <h4 className="text-sm font-medium text-gray-900">Meeting Detection</h4>
              <p className="text-sm text-gray-500">Get notified when meetings are detected</p>
            </div>
            <input
              type="checkbox"
